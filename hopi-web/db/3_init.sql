...
insert into HW_DICT_TYPE(ID,TYPE,TYPE_CODE,ITEM,ITEM_CODE,SEQ,MODIFY_TIME) values('6','岗位状态','POSITION_STATUS','有效','POSITION_STATUS_VALID',1,sysdate);
insert into HW_DICT_TYPE(ID,TYPE,TYPE_CODE,ITEM,ITEM_CODE,SEQ,MODIFY_TIME) values('7','岗位状态','POSITION_STATUS','锁定','POSITION_STATUS_LOCK',2,sysdate);
