...
public class WebConstants {
	...
	// public static final String JCAPTCHA_CODE = "jcaptchaCode";//
	// 图形验证码session变量名
	public static final String RESOURCE_TYPE_URL = "0010";// URL资源
	public static final String RESOURCE_TYPE_MENU = "0011";// 菜单资源
	public static final String RESOURCE_TYPE_ICON = "0012";// 菜单资源

	public static final String USER_STATUS_VALID = "0020";
	public static final String USER_STATUS_LOCK = "0021";
	public static final String USER_STATUS_DELETE = "0022";

	public static final String POSITION_STATUS_VALID = "0030";
	public static final String POSITION_STATUS_LOCK = "0031";
	public static final String POSITION_STATUS_DELETE = "0032";
