--客户基金产品分类明细
drop table #temp_khjjflmx;
create table #temp_khjjflmx
(
	...
	,constraint pk_skb_temp_khjjflmx primary key (nian,yue,zjzh,jjdm)	
);
...
(
	...
	left join #temp_khxs t_khxs on t_all.产品类型=t_khxs.产品类型	--考核系数
	...
	group by t_all.zjzh,t_all.jjdm,t_all.产品类型,t_khxs.考核系数,t_khxs.责权关系类型
)