...
left join dba.t_ddw_yunying2012_kh t2 on t1.zjzh=t2.zjzh and t2.nian=@nian and t2.yue=@yue
left join dba.t_ddw_zrqygx t_gx on t2.khbh_hs=t_gx.khbh_hs and t_gx.nian=@nian and t_gx.yue=@yue
where t_gx.khbh_hs is null