...
//			},
//			defaultType : 'toolbar',
//			items:[this.secureToolBar,this.queryForm]
//		});
//		this.secureToolBar=Ext.create("Ext.Toolbar", {			
//			items:['test']
//		});
...
//		});
		...
		this.toolBar=Ext.create("Hopi.common.SecureToolBar", {			
			items:[]
		});
		this.callParent();
	}
